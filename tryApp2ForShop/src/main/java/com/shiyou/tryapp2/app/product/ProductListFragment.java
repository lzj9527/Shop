...
public class ProductListFragment extends BaseFragment
{
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
	{
		...
		if(category.equals("34")){
			...
			replace(getActivity(), ResourceUtil.getId(getContext(), "product_list"), new MainWebFragment("http://www.i888vip.com/addons/ewei_shop/template/pad/default/shop/new-list.html?isSearch=false&sku=''&goodsType=" + goodstype + "&cid=" + category + "&customization=" + customization, 0), false);
		}
